...
- [ ] Confirm the current npm `@mermaid-js/mermaid-cli` and Homebrew `d2` versions render `docs/examples/all-features.md`.
...
- [ ] Confirm both `DiagramDown-<version>-arm64.dmg` and its `.sha256` file are attached.
